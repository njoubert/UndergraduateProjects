  ...
  def showBeliefs(self, locations, beliefs, ghosts):
    ...
    for pos in locations:
      ...
      if SHOW_GHOSTS and pos in ghosts:
        ...
        leftEye = circle((screen_x+0.7*GRID_SIZE*GHOST_SIZE*(-0.3+dx/1.5), screen_y-0.7*GRID_SIZE*GHOST_SIZE*(0.3-dy/1.5)), 0.7*GRID_SIZE*GHOST_SIZE*0.1, WHITE, WHITE)
        rightEye = circle((screen_x+0.7*GRID_SIZE*GHOST_SIZE*(0.3+dx/1.5), screen_y-0.7*GRID_SIZE*GHOST_SIZE*(0.3-dy/1.5)), 0.7*GRID_SIZE*GHOST_SIZE*0.1, WHITE, WHITE)
        leftPupil = circle((screen_x+0.7*GRID_SIZE*GHOST_SIZE*(-0.3+dx), screen_y-0.7*GRID_SIZE*GHOST_SIZE*(0.3-dy)), 0.7*GRID_SIZE*GHOST_SIZE*0.04, BLACK, BLACK)
        rightPupil = circle((screen_x+0.7*GRID_SIZE*GHOST_SIZE*(0.3+dx), screen_y-0.7*GRID_SIZE*GHOST_SIZE*(0.3-dy)), 0.7*GRID_SIZE*GHOST_SIZE*0.04, BLACK, BLACK)
