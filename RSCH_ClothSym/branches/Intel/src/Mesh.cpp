...
mat3 & TriangleMeshVertex::getDfDx() { return DfDx; }
void TriangleMeshVertex::setDfDx(mat3 tmp) { DfDx += tmp; }
void TriangleMeshVertex::clearDfDx() { DfDx = mat3(0); }

mat3 & TriangleMeshVertex::getDfDv() { return DfDv; }
