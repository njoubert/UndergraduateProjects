...
{
	/*
	m_Mx[0] = m_Mx[4] = m_Mx[8] = (double)1.0;
	m_Mx[1] = m_Mx[2] = m_Mx[3] = m_Mx[5] = m_Mx[6] = m_Mx[7] = (double)0.0;
	//*/
}
...
void Physics_Matrix3x3::Multiply( double scale, Physics_Matrix3x3 &Dst )
{
	for( int i=0; i<9; i++ )
...
void Physics_Matrix3x3::Set( double a00, double a01, double a02,
...
void Physics_Matrix3x3::SetTilde( double x, double y, double z )
{
