...
public:
    ...
    inline Vector4<Real> TransposeTimes (const Vector4<Real>& rkV) const {
       return Vector4<Real>(
        rkV[0]*m_afEntry[0]+rkV[1]*m_afEntry[4]+rkV[2]*m_afEntry[8]+rkV[3]*m_afEntry[12],
        rkV[0]*m_afEntry[1]+rkV[1]*m_afEntry[5]+rkV[2]*m_afEntry[9]+rkV[3]*m_afEntry[13],
        rkV[0]*m_afEntry[2]+rkV[1]*m_afEntry[6]+rkV[2]*m_afEntry[10]+rkV[3]*m_afEntry[14],
        rkV[0]*m_afEntry[3]+rkV[1]*m_afEntry[7]+rkV[2]*m_afEntry[11]+rkV[3]*m_afEntry[15]);
    }
