...
void
q_euler_to_col_matrix(q_matrix_type destMatrix, 
...
q_col_matrix_to_euler(q_vec_type angles, q_matrix_type colMatrix)
    /* angles holds outgoing roll, pitch, yaw */
    /* colMatrix holds incoming rotation */
{
...
void
q_matrix_mult(q_matrix_type resultMatrix, 
              q_matrix_type leftMatrix, q_matrix_type rightMatrix)
{
    int	    	    i;
    int	    	    r, c;
...
void
qogl_matrix_mult(qogl_matrix_type result, 
                 qogl_matrix_type left, qogl_matrix_type right )
{
    int i, r, c;
