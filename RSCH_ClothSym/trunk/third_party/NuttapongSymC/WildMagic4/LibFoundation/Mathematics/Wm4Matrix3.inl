...
template <class Real>
inline Vector3<Real> Matrix3<Real>::TransposeTimes (const Vector3<Real>& v) const {
   return Vector3<Real>(
      m_afEntry[0]*v[0] + m_afEntry[3]*v[1] + m_afEntry[6]*v[2],
      m_afEntry[1]*v[0] + m_afEntry[4]*v[1] + m_afEntry[7]*v[2],
      m_afEntry[2]*v[0] + m_afEntry[5]*v[1] + m_afEntry[8]*v[2]);
