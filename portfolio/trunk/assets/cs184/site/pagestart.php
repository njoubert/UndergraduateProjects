...
<title>CS184-DV - Niels Joubert's Graphics Site</title>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="10" cellpadding="0">
      	<tr>
        		<td class="logo_area">CS184: Niels Joubert </td>          
      	</tr>
    	</table>
    </td>
...
<!--        <td><div class="navigation"><a href="index.php?page=assignments" class="main_link">Assignments</a></div></td> -->
        ...
        <td><div class="navigation"><a href="http://njoubert.blogspot.com/" class="main_link">My Blog</a></div></td>
      </tr>
    </table></td>
    <td class="horizontal_column">&nbsp;</td>
  </tr>
  <tr>
    <td class="shadow_left">&nbsp;</td>
    <td class="below_header">Niels Joubert's Foundations of Graphics web page. <br><i>'to make, little by little, the faulty good, the good better, and the better perfect.'</i?</td>
    <td class="shadow_right">&nbsp;</td>
  </tr>
  <tr>
    <td class="shadow_left">&nbsp;</td>
